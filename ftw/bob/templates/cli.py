...
logger = logging.getLogger('ftw.bob.templates')

# This templates are allowed to create.
# Key: Template-Name
# Value: 'mr.bob template-path'
AVAILABLE_TEMPLATES = {
    'web': 'ftw.bob.templates:web',
    'workspace': 'ftw.bob.templates:workspace'
    }

# example: ~/projects/ftw.bob.templates/ftw/bob/templates
MODULE_PATH = os.path.dirname(__file__)

# example: ~/projects/ftw.bob.templates/ftw/bob/templates/scripts
SCRIPTS_PATH = os.path.join(MODULE_PATH, 'scripts')

# example: ~/projects/ftw.bob.templates
FTW_BOB_ROOT_PATH = os.path.realpath(
    os.path.join(MODULE_PATH, os.pardir, os.pardir, os.pardir))

# example: ~/projects/ftw.bob.templates/ftw/bob/templates/autogenerate
AUTOGENERATE_CONFIG_PATH = os.path.join(MODULE_PATH, 'autogenerate')

# Generated packages will be stored in this folder
TARGET_DIR = os.path.join(FTW_BOB_ROOT_PATH, 'generated')
...
class TemplateGeneratorCLI(object):
    ...
    def __init__(self, args):
        ...
        self.generated_package_path = os.path.join(
            FTW_BOB_ROOT_PATH, TARGET_DIR, self.config.get('package.fullname'))
...
def test_template(args=sys.argv[1:]):
